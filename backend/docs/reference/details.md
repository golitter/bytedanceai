...
- [01-models.md](design/01-models.md) — 数据模型（Task / Session / Message GORM 模型）
- [02-handlers.md](design/02-handlers.md) — HTTP 处理器（Task CRUD / Session / Message / Agent / Avatar / Stream）
